...
using AspNetCore.MaxConcurrentRequests;
...
namespace Test.AspNetCore.MaxConcurrentRequests
{
    public class MaxConcurrentRequestsTests
    {
        ...
        #region Fields
        private const string DEFAULT_RESPONSE = "-- AspNetCore.MaxConcurrentConnections --";

        private const int SOME_CONCURRENT_REQUESTS_COUNT = 10000;
